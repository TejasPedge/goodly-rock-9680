...
import { LogoutMenu } from "../HomePage Components/LogoutMenu";
...
const Navbar = () => {
  ...
  return (
    <Box>
      <Box
        bg={useColorModeValue("white", "#001E3C")}
        py={{ base: "7px", "620px": "16px" }}
      >
        <HStack
        ...
        >
          ...
          <HStack key={Math.random} w={{ "620px": "none" }}>
            <Box mr="10px" display={{ base: "flex", "620px": "none" }}>
              <HiMenuAlt1
                onClick={onOpen}
                color={useColorModeValue("black", "aqua")}
                size="25px"
              />
            </Box>
              ...
              <Link to="/">
                <Image
                  ...
                  src={useColorModeValue(
                    MobileScreen_Logo_LT,
                    MobileScreen_Logo_DT
                  )}
                ></Image>
              </Link>
            </Box>
            ...
            <Box display={{ base: "none", "620px": "block" }}>
              <Link to="/">
                <Image
                  w={{ base: "190px", "929px": "220px" }}
                  src={useColorModeValue(
                    LightTheme_cureconnect_Logo,
                    DarkTheme_cureconnect_Logo
                  )}
                ></Image>
              </Link>
            </Box>
          ...
          <HStack
            key={Math.random()}
            w={{ base: "120px", "301px": "120px", "620px": "220px" }}
            justify={"space-between"}
          >
            {isLoggedIn ? (
              <LogoutMenu Username={user} />
            ) : (
              <Link to="/login">
                <Button
                  display={{ base: "none", "620px": "block" }}
            ...
            <Box position="relative" cursor={"pointer"}>
              <FiShoppingCart
                color={useColorModeValue("#33333e", "aqua")}
                size={"20px"}
              />
              <Badge
                textAlign={"center"}
                ...
                minW="15px"
                border="2px solid"
                borderColor={useColorModeValue("white", "#001E3C")}
                borderRadius={"50%"}
                bg={useColorModeValue("#83f2a6", "#2e5bc5")}
                position="absolute"
                top="-2"
                right="-2"
              >
            ...
            <Box cursor={"pointer"} variant={"none"} onClick={toggleColorMode}>
              {colorMode === "light" ? (
                ...
                <MdDarkMode size="20px" color="aqua" />
              )}
            </Box>
          </HStack>
        </HStack>
