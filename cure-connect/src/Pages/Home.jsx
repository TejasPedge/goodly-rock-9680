...
const Home = () => {
  ...
  return (
    <Box>
      <Box
        display={{ base: "none", "620px": "block" }}
        py="11px"
        pb="20px"
        px={{ base: "none", "620px": "10px" }}
        bg={useColorModeValue("#effbfc", "#06325f")}
      >
        <Text
          display={{ base: "none", "620px": "block" }}
          textAlign={"center"}
          ...
          fontSize={"13px"}
        >
          Sale is Live Now | Get Extra 10% Off | Exciting Freebies & Extra 5% HK
          Cash, T&Cs Apply*
        </Text>
      ...
      <Box bg={useColorModeValue("#fff", "#001E3C")}>
        <Box w={{ base: "95%", "816px": "85%", "1063px": "78%" }} m="auto">
          <HStack pt={"15px"} justify={"space-between"}>
            <Text fontWeight={600} fontSize={{ base: "17px", "478px": "23px" }}>
              Blockbuster Deals
            </Text>
            <Text
              cursor={"pointer"}
              fontWeight={useColorModeValue(600, 500)}
              color={useColorModeValue("#00b5b7", "#13f1f5")}
              fontSize={"14px"}
            >
              View All
            </Text>
      ...
      <Box mt="7px" bg={useColorModeValue("#fff", "#001E3C")}>
        ...
        >
          ...
          <Box mt="15px">
            <TopSlider
              speed={400}
              data={afterMembershipSlider_data}
              autoplay={false}
              isRounded={true}
            />
          </Box>
      ...
      <Box mt="7px" bg={useColorModeValue("#fff", "#001E3C")}>
        ...
        >
          ...
          <SimpleGrid
            columnGap={"110px"}
            rowGap={"20px"}
            columns={{ base: 1, "455px": 2, "751px": 3 }}
            pt="15px"
          >
            <Stack spacing={"15px"}>
              <Image
      ...
      <Box
        display={{ base: "none", "620px": "flex" }}
        mt="7px"
        bg={useColorModeValue("#fff", "#001E3C")}
      >
        <Box
          py="20px"
          w={{ base: "95%", "816px": "85%", "1063px": "78%" }}
        ...
        >
          <Flex
            flexDirection={{ base: "column", "955px": "row" }}
          ...
          >
            ...
            <Stack w={{ base: "100%", "955px": "50%" }}>
              ...
              >
                <Stack px="30px" py="20px" pb="25px">
                  ...
                  <Text pb="15px" pt="5px" fontWeight={400} fontSize={13}>
                    Earn extra HK Cash & Enjoy more discounts and deals than
                    anyone else!
                  </Text>
                  <Box
                    cursor={"pointer"}
                ...
                <Image
                  ...
                  w="125px"
                  h="125px"
                  src="https://static1.hkrtcdn.com/hknext/static/media/common/misc/subscribe.svg"
                ></Image>
              </Flex>
              ...
              <Flex
                justify={"space-between"}
                bg={useColorModeValue("#f7f7f7", "#193479")}
                borderRadius={"25px"}
              >
                <Stack w="48%" pl="30px" py="20px">
                  ...
                  <Text fontSize="12.3">
                    Tell your friends to shop at HealthKart. They get Rs.200 off
                    when they shop with us the 1st time & you get Rs. 200 off on
                    your next order.
                  </Text>
                  <HStack>
            ...
            <Box
              display={{ base: "none", "955px": "flex" }}
              position={"relative"}
              overflow={"hidden"}
              borderRadius={"25px"}
              bg={useColorModeValue("#f6f6f6", "#193479")}
              w="49%"
            >
              <Stack justifyContent={"space-between"}>
                <Stack px="30px" pt="20px">
                  ...
                  <Text pb="40px" pt="10px" w="70%" fontSize="20px">
                    Wish to seek advise from nutritionists and dietitians?
                  </Text>
                  <Box
                    cursor={"pointer"}
                    w="46%"
                ...
                <Box position={"absolute"} bottom={0}>
                  <Image
                    w="100%"
                    src="	https://static1.hkrtcdn.com/hknext/static/media/common/misc/bg-wave.svg"
                  ></Image>
                </Box>
                <Image
                  w="58%"
      ...
      >
        ...
        >
          <Flex
            ...
            bg={useColorModeValue("#ffffff", "#193479")}
            borderRadius={"10px"}
          ...
          >
            <Stack w="55%" pl="6px" py="10px">
              ...
              <Text fontSize="12">
                Tell your friends to shop at HealthKart. & Earn upto ₹200 when
                they shop with us
              </Text>
              <HStack>
                <Text fontSize="12">Refer now</Text>
            ...
            >
              <Image
                w="100%"
                src="https://static1.hkrtcdn.com/hknext/static/media/common/misc/rne_refer_back.svg"
              ></Image>
              <Image
                w="77%"
                position={"absolute"}
